...
export default function ElectoralHub() {
        ...
        <div className="max-w-md mx-auto">
          <Card className="group hover:shadow-lg transition-all duration-300 border-2 hover:border-primary/20">
            ...
            <CardContent className="space-y-4">
              ...
              <Button 
                variant="outline" 
                className="w-full group-hover:bg-green-50 dark:group-hover:bg-green-950 group-hover:border-green-300 group-hover:text-green-700 dark:group-hover:text-green-300 group-hover:scale-105 transition-all"
                onClick={() => navigate('/student/electoral')}
                disabled={currentPhase === 'applications'}
              >
                {currentPhase === 'applications' ? 'Results Not Available' : 'View Live Dashboard'}
